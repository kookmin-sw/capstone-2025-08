        ...
        "phase_list": [
            {
                ...
                "batch_size": {"train": 2, "valid": 2,},  # Adjusted for small dataset size
                "nr_epochs": 1, # Set to 1 epoch for quick testing
            },
# ... existing code ...

            {
                ...
                "target_info": {"gen": (gen_targets, {}), "viz": (prep_sample, {})},
                "batch_size": {"train": 2, "valid": 2,}, # Adjusted for small dataset size
                "nr_epochs": 1, # Set to 1 epoch for quick testing (if both phases should run for 1 epoch)
            },
        ],
        # ------------------------------------------------------------------
        ...
        "run_engine": {
            "train": {
                ...
                "nr_procs": 4,  # Reduced number of threads for dataloader
            ...
            "valid": {
                "dataset": "",  # whats about compound dataset ?
                "nr_procs": 2,  # Reduced number of threads for dataloader
                "run_step": valid_step,
