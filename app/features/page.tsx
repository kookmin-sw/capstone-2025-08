        ...
        <div className="container mx-auto px-4 mt-20">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground">
              병리학자를 위한 최적의 AI 솔루션이 제공하는 핵심 기능들을 살펴보세요.
            </p>
          </motion.div>
        </div>
      </motion.section>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-br from-primary/20 to-secondary/20 z-0"></div>
              <Image
                src="/placeholder.svg?height=500&width=500&text=Dual-Branch+Architecture"
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                title: "모델 공유 및 다운로드",
                description: "학습한 커스텀 모델을 커뮤니티(퍼블릭 스페이스)에 공유하고, 손쉽게 다운로드할 수 있습니다.",
                delay: 0.4,
              },
              {
                icon: <Layers className="h-6 w-6" />,
                title: "선택적 데이터셋 공개",
                description: "데이터 보안을 유지하면서도 필요한 경우 커뮤니티와 데이터셋을 공유할 수 있습니다.",
                delay: 0.5,
              },
              {
                icon: <Brain className="h-6 w-6" />,
                title: "협진을 위한 퍼블릭 스페이스",
                description: "다양한 전문가와 함께 토론하고 협업할 수 있는 공간을 제공합니다.",
                delay: 0.6,
              },
            ].map((feature, index) => (
              <motion.div
