...
export class ProjectAPIApi extends runtime.BaseAPI {
     ...
     * 프로젝트 상세 화면을 조회합니다.
     */
    async getProjectDetailRaw(requestParameters: GetProjectDetailRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetProjectDetailResponseDto>> {
        if (requestParameters['projectId'] == null) {
            throw new runtime.RequiredError(
                'projectId',
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => GetProjectDetailResponseDtoFromJSON(jsonValue));
    }

    /**
     * 프로젝트 상세 화면을 조회합니다.
     */
    async getProjectDetail(requestParameters: GetProjectDetailRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetProjectDetailResponseDto> {
     ...
     * 서브 프로젝트를 조회합니다.
     */
    async getSubProject1Raw(requestParameters: GetSubProject1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetSubProjectResponseDto>> {
        if (requestParameters['projectId'] == null) {
            throw new runtime.RequiredError(
                'projectId',
        ...
        const response = await this.request({
            path: `/api/projects/annotation/{projectId}`.replace(`{${"projectId"}}`, encodeURIComponent(String(requestParameters['projectId']))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => GetSubProjectResponseDtoFromJSON(jsonValue));
    }
     ...
     * 서브 프로젝트를 조회합니다.
     */
    async getSubProject1(requestParameters: GetSubProject1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetSubProjectResponseDto> {
        const response = await this.getSubProject1Raw(requestParameters, initOverrides);
        return await response.value();
    }
