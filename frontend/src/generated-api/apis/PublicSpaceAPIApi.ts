...
export class PublicSpaceAPIApi extends runtime.BaseAPI {
    ...
    async createCommentRaw(requestParameters: CreateCommentRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        ...
        const response = await this.request({
            path: `/api/public-space/shared-projects/{sharedProjectId}/comments`.replace(`{${"sharedProjectId"}}`, encodeURIComponent(String(requestParameters['sharedProjectId']))),
            method: 'POST',
     ...
     * 공유 프로젝트 생성
     */
    async createPostRaw(requestParameters: CreatePostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<number>> {
        ...
        if (requestParameters['requestDto'] != null) {
            formParams.append('requestDto', new Blob([JSON.stringify(numberToJSON(requestParameters['requestDto']))], { type: "application/json", }));
                    }
     ...
     * 공유 프로젝트 생성
     */
    async createPost(requestParameters: CreatePostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<number> {
    ...
    async deleteCommentRaw(requestParameters: DeleteCommentRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        ...
        const response = await this.request({
            path: `/api/public-space/shared-projects/{sharedProjectId}/comments/{commentId}`.replace(`{${"sharedProjectId"}}`, encodeURIComponent(String(requestParameters['sharedProjectId']))).replace(`{${"commentId"}}`, encodeURIComponent(String(requestParameters['commentId']))),
            method: 'DELETE',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async downloadModelRaw(requestParameters: DownloadModelRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        ...
        const response = await this.request({
            path: `/api/public-space/shared-projects/{sharedProjectId}/model-download/{modelId}`.replace(`{${"sharedProjectId"}}`, encodeURIComponent(String(requestParameters['sharedProjectId']))).replace(`{${"modelId"}}`, encodeURIComponent(String(requestParameters['modelId']))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     * 댓글 조회
     */
    async getCommentsRaw(requestParameters: GetCommentsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetSharedProjectCommentsResponseDto>> {
        if (requestParameters['sharedProjectId'] == null) {
            throw new runtime.RequiredError(
                'sharedProjectId',
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => GetSharedProjectCommentsResponseDtoFromJSON(jsonValue));
    }
     ...
     * 댓글 조회
     */
    async getComments(requestParameters: GetCommentsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetSharedProjectCommentsResponseDto> {
     ...
     * 프로젝트 목록 및 관련 모델 조회
     */
    async getProjectWithModelsRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetProjectWithModelsResponseDto>> {
        const queryParameters: any = {};
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => GetProjectWithModelsResponseDtoFromJSON(jsonValue));
    }
     ...
     * 프로젝트 목록 및 관련 모델 조회
     */
    async getProjectWithModels(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetProjectWithModelsResponseDto> {
     ...
     * 공유 프로젝트 상세 조회
     */
    async getSharedProjectRaw(requestParameters: GetSharedProjectRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetSharedProjectDetailResponseDto>> {
        if (requestParameters['sharedProjectId'] == null) {
            throw new runtime.RequiredError(
                'sharedProjectId',
        ...
        const response = await this.request({
            path: `/api/public-space/shared-projects/{sharedProjectId}`.replace(`{${"sharedProjectId"}}`, encodeURIComponent(String(requestParameters['sharedProjectId']))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => GetSharedProjectDetailResponseDtoFromJSON(jsonValue));
    }
     ...
     * 공유 프로젝트 상세 조회
     */
    async getSharedProject(requestParameters: GetSharedProjectRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetSharedProjectDetailResponseDto> {
     ...
     * 공유 프로젝트 목록 조회
     */
    async getSharedProjectsResponseDtoResponseEntityRaw(requestParameters: GetSharedProjectsResponseDtoResponseEntityRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetSharedProjectsResponseDto>> {
        const queryParameters: any = {};
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => GetSharedProjectsResponseDtoFromJSON(jsonValue));
    }
     ...
     * 공유 프로젝트 목록 조회
     */
    async getSharedProjectsResponseDtoResponseEntity(requestParameters: GetSharedProjectsResponseDtoResponseEntityRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetSharedProjectsResponseDto> {
        const response = await this.getSharedProjectsResponseDtoResponseEntityRaw(requestParameters, initOverrides);
        return await response.value();
    }
    ...
    async updateCommentRaw(requestParameters: UpdateCommentRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: UpdateCommentRequestDtoToJSON(requestParameters['updateCommentRequestDto']),
        }, initOverrides);
