...
export class ProjectAnnotationAPIApi extends runtime.BaseAPI {
    ...
    async uploadRoisRaw(requestParameters: UploadRoisRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        ...
        const response = await this.request({
            path: `/api/annotation/sub-projects/{subProjectId}/histories/{annotationHistoryId}/save`.replace(`{${"subProjectId"}}`, encodeURIComponent(String(requestParameters['subProjectId']))).replace(`{${"annotationHistoryId"}}`, encodeURIComponent(String(requestParameters['annotationHistoryId']))),
            method: 'POST',
