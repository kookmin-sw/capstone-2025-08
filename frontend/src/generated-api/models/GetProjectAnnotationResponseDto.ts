 ...
 */
export function instanceOfGetProjectAnnotationResponseDto(
  value: object,
): value is GetProjectAnnotationResponseDto {
  return true;
}

export function GetProjectAnnotationResponseDtoFromJSON(
  json: any,
): GetProjectAnnotationResponseDto {
  return GetProjectAnnotationResponseDtoFromJSONTyped(json, false);
}

export function GetProjectAnnotationResponseDtoFromJSONTyped(
  json: any,
  ...
  return {
    ...
    modelsDto: json['modelsDto'] == null ? undefined : json['modelsDto'],
    labels:
      json['labels'] == null
        ? undefined
        : (json['labels'] as Array<any>).map(ProjectLabelDtoFromJSON),
    subProjects:
      json['subProjects'] == null
        ? undefined
        : (json['subProjects'] as Array<any>).map(SubProjectSummaryDtoFromJSON),
    firstSubProjectId:
      json['firstSubProjectId'] == null ? undefined : json['firstSubProjectId'],
  };
}

export function GetProjectAnnotationResponseDtoToJSON(
  json: any,
): GetProjectAnnotationResponseDto {
  return GetProjectAnnotationResponseDtoToJSONTyped(json, false);
}

export function GetProjectAnnotationResponseDtoToJSONTyped(
  value?: GetProjectAnnotationResponseDto | null,
  ...
  return {
    ...
    labels:
      value['labels'] == null
        ? undefined
        : (value['labels'] as Array<any>).map(ProjectLabelDtoToJSON),
    subProjects:
      value['subProjects'] == null
        ? undefined
        : (value['subProjects'] as Array<any>).map(SubProjectSummaryDtoToJSON),
